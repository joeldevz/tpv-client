          ...
          <div className="max-w-md w-full space-y-8 m-auto">
            <div>
              ...
              <p className="mt-2 text-center text-sm text-gray-600">
                ...
                <br />
                <Link href="/">
                  <a className="font-medium text-blue-600 hover:text-blue-500 mt-5">
            ...
            >
              ...
              <p className=" text-center text-xs text-gray-600">
                <p className="font-medium text-gray-600">
                  * Utiliza ocho caracteres como mínimo con una combinación de
                  letras, números y símbolos
                </p>
              </p>

              <p className=" text-center text-sm text-gray-600">
                <p className="font-medium text-red-600 text-center hover:text-red-500">
                  {error}
                </p>
              </p>
              <div>
